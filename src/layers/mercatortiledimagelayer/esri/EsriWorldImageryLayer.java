...
public class EsriWorldImageryLayer extends BasicMercatorTiledImageLayer {
    public static final String LAYERNAME = "Esri World Imagery";

    public EsriWorldImageryLayer() {
        super(makeLevels());
    ...
    private static LevelSet makeLevels() {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Esri/WorldImagery");
        params.setValue(AVKey.SERVICE, "http://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer");
