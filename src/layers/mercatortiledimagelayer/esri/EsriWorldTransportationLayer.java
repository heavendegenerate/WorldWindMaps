...
public class EsriWorldTransportationLayer extends BasicMercatorTiledImageLayer {
    public static final String LAYERNAME = "Esri World Transportation";

    public EsriWorldTransportationLayer() {
        super(makeLevels());
    ...
    private static LevelSet makeLevels() {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Esri/WorldTransportation");
        params.setValue(AVKey.SERVICE, "http://services.arcgisonline.com/ArcGIS/rest/services/Reference/World_Transportation/MapServer");
