...
public class TencentMercatorMapLayer extends BasicMercatorTiledImageLayer {
    public static final String LAYERNAME = "Tencent Map Mercator";

    public TencentMercatorMapLayer() {
        super(makeLevels());
    ...
    private static LevelSet makeLevels() {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Tencent/MercatorMap");
        params.setValue(AVKey.SERVICE, "http://rt0.map.gtimg.com/tile");
        params.setValue(AVKey.LAYER_NAME, "vector");
    ...
    private static class URLBuilder implements TileUrlBuilder {
            ...
            throws MalformedURLException
        {
            ...
            System.out.println("maxLatPercent:"+ gudermannian(1).getDegrees());
            ...
            String fullurl =  serverURL + "?z=" + level +"&x=" + col + "&y="+ row+"&styleid=0&version=227";
