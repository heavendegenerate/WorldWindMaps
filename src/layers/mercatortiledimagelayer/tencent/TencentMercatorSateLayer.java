...
public class TencentMercatorSateLayer extends BasicMercatorTiledImageLayer {
    public static final String LAYERNAME = "Tencent Sate Mercator";

    public TencentMercatorSateLayer() {
        super(makeLevels());
    ...
    private static LevelSet makeLevels() {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Tencent/MercatorSate");
    ...
    private static class URLBuilder implements TileUrlBuilder {
            ...
            throws MalformedURLException
        {
            ...
            String fullurl =  serverURL + "?z=" + level +"&x=" + col + "&y="+ row+"&type=sate&styleid=1&version=227";
