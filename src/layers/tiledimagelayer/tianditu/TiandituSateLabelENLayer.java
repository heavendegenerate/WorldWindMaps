...
public class TiandituSateLabelENLayer extends WMSTiledImageLayer
{
    public static final String LAYERNAME = "Tianditu Sate Label EN";

    public TiandituSateLabelENLayer() {
        super(makeLevels());
    ...
    private static AVList makeLevels()
    {
        ...
        params.setValue(AVKey.DATA_CACHE_NAME, "Tianditu/SateLabelEN");	//缓存目录
        params.setValue(AVKey.SERVICE, "http://t0.tianditu.com/eia_c/wmts");//服务地址
    ...
    private static class URLBuilder implements TileUrlBuilder
    {
            ...
            throws MalformedURLException
        {
            ...
            //瓦片URL串
            String fullurl = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=eia&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix="+level+"&TileRow="+row+"&TileCol=" + col;
