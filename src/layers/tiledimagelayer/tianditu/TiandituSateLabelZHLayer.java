...
public class TiandituSateLabelZHLayer extends WMSTiledImageLayer
{
    public static final String LAYERNAME = "Tianditu Sate Label ZH";

    public TiandituSateLabelZHLayer() {
        super(makeLevels());
    ...
    private static class URLBuilder implements TileUrlBuilder
    {
            ...
            throws MalformedURLException
        {
            ...
            //瓦片URL串
            String fullurl = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=cia&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix="+level+"&TileRow="+row+"&TileCol=" + col;
