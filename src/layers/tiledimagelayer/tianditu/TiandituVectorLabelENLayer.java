...
public class TiandituVectorLabelENLayer extends WMSTiledImageLayer
{
    public static final String LAYERNAME = "Tianditu Vector Label EN";

    public TiandituVectorLabelENLayer() {
        super(makeLevels());
    ...
    private static class URLBuilder implements TileUrlBuilder
    {
            ...
            throws MalformedURLException
        {
            ...
            //瓦片URL串
            String fullurl = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=eva&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix="+level+"&TileRow="+row+"&TileCol=" + col;
