...
public class TiandituVectorLayer extends WMSTiledImageLayer
{
    public static final String LAYERNAME = "Tianditu Vector";
    ...
    private static AVList makeLevels()
    {
        ...
        params.setValue(AVKey.NUM_EMPTY_LEVELS, 1);		//开始级数
    ...
    private static class URLBuilder implements TileUrlBuilder
    {
            ...
            throws MalformedURLException
        {
            ...
            //瓦片URL串
            String fullurl = serverURL + "?request=GetTile&service=wmts&version=1.0.0&serviceMode=kvp&layer=vec&Style=default&Format=tiles&TileMatrixSet=c&TileMatrix="+level+"&TileRow="+row+"&TileCol=" + col;
