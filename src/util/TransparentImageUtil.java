 ...
 */
public class TransparentImageUtil
{
    ...
    public static AVList openSpatialImage(File imageFile, int interpolation_mode) throws IOException
    {
        ...
        if (sector == null)
            TransparentImageUtil.reprojectUtmToGeographic(values, interpolation_mode);
    ...
    {
        return openSpatialImage(imageFile, TransparentImageUtil.NEAREST_NEIGHBOR_INTERPOLATION);
    }
        ...
        throws IOException
    {
        ...
        TransparentImageUtil.readGeoKeys(reader, imageIndex, values);
    ...
    public static void reprojectUtmToGeographic(AVList values, int mode)
    {
        ...
        for (int y = 0; y < height; y++)
        {
            for (int x = 0; x < width; x++)
            {
                ...
                if (mode == TransparentImageUtil.BILINEAR_INTERPOLATION)
                {
...
//        return gc.createCompatibleImage(width, height, transparency);
    ...
    public static ByteBuffer asJPEG(DataRaster raster)
    {
        ...
        {
            image = TransparentImageUtil.visualize((BufferWrapperRaster) raster);
        }
        else
        {
